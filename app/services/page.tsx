...
export const metadata: Metadata = {
  ...
  description:
    "Девять направлений в одной клинике: имплантация, эстетика, терапия под микроскопом, ортодонтия, протезирование, хирургия, пародонтология, гигиена и детская стоматология.",

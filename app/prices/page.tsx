...
export const metadata: Metadata = {
  ...
  description:
    "Полный прайс-лист клиники AURUM: имплантация 55 000–120 000 ₽, виниры 38 000–62 000 ₽, лечение кариеса 8 500–19 000 ₽. Честные диапазоны без формата «от», рассрочка 0%.",

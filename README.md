...
- тонированная канва: `canvas` (#f0f1f4) — бумага страницы, `white` —
  ...
  островами — на этом и держится глубина светлых страниц. Оттенок снят
  замером с первого экрана: фон вокруг его текстовой колонки — #f0f0f2,
  почти нейтральный, и канва подогнана под него, иначе главная и
  внутренние страницы выглядели из разных наборов;
- фон светлых страниц — два слоя на `body`, оба `position: fixed`, поэтому
  ...
  широких размывки (синяя, шампанская, зелёная, пик насыщенности около 9%),

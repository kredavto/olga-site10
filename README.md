...
- первый экран стоит на фотографии (`public/media/hero-bg.jpeg`) и работает в
  ...
  кнопку, градиентную строку заголовка, сетку и зерно, а `.on-light` внутри
  него возвращает светлый остров — панель записи. Шапка на главной, пока
  страница не прокручена, тоже переходит в белые чернила;
